...
const CustomFileUpload = ({
    ...
    const handleFileSelect = (e) => {
        ...
        if (selectedFile) {
            if (ACCEPTED_FILE_TYPES.includes(selectedFile.type)) {
                ...
                toast.error(
                    `Invalid file type. Only JPG, PNG ${fileType ? ", and PDF" : ""
                    } files are accepted.`
                );
            }
        }
    ...
    return (
        <div className="space-y-1.5">
            ...
            <div
                className={`p-0.5 border-black ${borderRadius} border-[2px] border-dashed rounded-[24px] ${disabled ? "" : "cursor-pointer"
                    }`}
            >
                <label
