...
const CompleteFileUpload = ({
    ...
    const belowSm = window.innerWidth < 640;
    ...
    const handleChange = (e) => {
        ...
        if (!isValidFileSize(e.target.files[0].size)) {
            ...
            allowPdf
                ? toast.error(
                    `Image/File size should be less than ${maxUploadSizeMB ? maxUploadSizeMB : 1
                    } MB`
                )
            ...
            >
                <label htmlFor={`fileInput-${formId}`} className="cursor-pointer">
                    ...
                    >
                        {file == "" ? (
                            <>
                                <span className="material-icons text-black" style={{ fontSize: "2rem" }}>upload</span>
                            ...
                            >
                                ...
                                <span className="material-icons cursor-pointer absolute right-[23px] text-black top-[14px]" onClick={(e) => {
                                    if (e && e.stopPropagation) e.stopPropagation();
                                    setFile("");
                                    setS3Url("");
                                    setFileType("");
                                    e.target.value = null;
                                }} style={{ fontSize: "1rem" }}>close</span>
                                <Image
                                    alt=""
                                ...
                                {showExitLargeScreenIcon && (
                                    <Image
                                        ...
                                        fontSize="large"
                                        src="/public/assets/icons/colorCross.svg"
                                        width="30"
                                        height="30"
                                        style={{
                                            color: "#12134D",
                            ...
                            <Image width="100" height="100" className="h-full" src={file} alt="Selected File Preview" />
                        )}
                    </div>
